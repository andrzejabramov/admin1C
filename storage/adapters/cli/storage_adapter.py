...
def main(args=None):
    ...
    # ЕДИНСТВЕННОЕ ИЗМЕНЕНИЕ: добавлен короткий флаг -I как алиас к --ib
    parser.add_argument("-I", "--ib", metavar="ИБ", help="Показать детальный список бэкапов для указанной ИБ")
