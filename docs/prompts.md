...
├── engines/
│ ├── license_list.sh # Список лицензий (табличный вывод)
│ ├── license_detail.sh # Чтение бинарных данных лицензии
│ ├── license_info.sh # Состояние лицензионного пула
│ ├── monitor.sh # Мониторинг доступности лицензий
│ └── backup.sh # Архивирование файлов лицензий
├── services/
│ ├── **init**.py
│ └── lic_service.py # get_license_list(), backup_licenses(), monitor_licenses()
├── adapters/cli/
│ ├── **init**.py
│ └── lic_adapter.py # lic list/backup/monitor + --help
└── config/
