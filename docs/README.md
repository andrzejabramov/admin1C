...
| [`storage`](cmd.md#storage) | Мониторинг хранилища: статистика диска, список бэкапов, валидация состояния, управление списком ИБ                   | `ib_1c storage`<br>`ib_1c storage list-ibs`<br>`ib_1c storage update-ib-list [--dry-run] [--confirm]` |
